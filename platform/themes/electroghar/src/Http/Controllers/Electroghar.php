...
namespace Theme\Electroghar\Http\Controllers;
...
use Theme\Electroghar\Http\Requests\SendDownloadAppLinksRequest;

class ElectrogharController extends PublicController
{
