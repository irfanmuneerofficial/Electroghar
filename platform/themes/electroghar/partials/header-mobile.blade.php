<header class="header header--mobile"style="background-color:white; border-bottom: 1px solid black;" data-sticky="{{ theme_option('sticky_header_mobile_enabled', 'yes') == 'yes' ? 'true' : 'false' }}">
